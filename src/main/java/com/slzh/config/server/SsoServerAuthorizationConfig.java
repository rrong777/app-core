package com.slzh.config.server;
...
public class SsoServerAuthorizationConfig extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                .withClient("rrong1")
                .secret("$2a$10$J57aLwc.CY/r8H8a8Bf8../m0VDWMr5Vr6qnDtIuo9yV/a.JAcRX6")
                .authorizedGrantTypes("authorization_code", "refresh_token")
                .redirectUris("http://127.0.0.1:8799/client1/login")
                .redirectUris("http://localhost:8799/client1/login")
                .redirectUris("http://example.com")
                .scopes("all")
                .and()
                .withClient("rrong2")
                .secret("$2a$10$isY1PzfSOSmhEAfJV6QzuOgDUXJ8gV/9UyH/IvK8df/RpnQpvy3yO")
    ...
    public static void main(String[] args) {
        ...
        System.out.println(passwordEncoder.encode("rrongSecret1"));
        System.out.println(passwordEncoder.encode("rrongSecret2"));
    }
    // 配置生成令牌使用jwt的
    @Override
